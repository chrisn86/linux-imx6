...
int ipu_cpmem_set_fmt(struct ipu_ch_param __iomem *cpmem, u32 pixelformat)
{
	...
	case V4L2_PIX_FMT_YUV420:
		/* pix format */
		ipu_ch_param_set_field(cpmem, IPU_FIELD_PFS, 2);
		/* burst size */
		ipu_ch_param_set_field(cpmem, IPU_FIELD_NPB, 63);
		break;
	case V4L2_PIX_FMT_UYVY:
		/* bits/pixel */
		ipu_ch_param_set_field(cpmem, IPU_FIELD_BPP, 3);
		/* pix format */
		ipu_ch_param_set_field(cpmem, IPU_FIELD_PFS, 0xA);
		/* burst size */
		ipu_ch_param_set_field(cpmem, IPU_FIELD_NPB, 31);
		break;
	case V4L2_PIX_FMT_YUYV:
		/* bits/pixel */
		ipu_ch_param_set_field(cpmem, IPU_FIELD_BPP, 3);
		/* pix format */
		ipu_ch_param_set_field(cpmem, IPU_FIELD_PFS, 0x8);
		/* burst size */
		ipu_ch_param_set_field(cpmem, IPU_FIELD_NPB, 31);
		break;
